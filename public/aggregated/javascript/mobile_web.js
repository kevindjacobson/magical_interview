...
/* ----------------------------------------------------------------------
   - public/javascripts/jquery-2.1.4.js (last modified: 2016-01-15 19:39:42 +0000)
   ---------------------------------------------------------------------- */
/*!
...
/* ----------------------------------------------------------------------
   - public/javascripts/underscore-1.8.3.js (last modified: 2016-01-15 19:39:42 +0000)
   ---------------------------------------------------------------------- */
//     Underscore.js 1.8.3
...
/* ----------------------------------------------------------------------
   - public/javascripts/jquery.bbq.js (last modified: 2016-01-21 00:14:18 +0000)
   ---------------------------------------------------------------------- */
/*!
...
(function($,window,undefined){
  ...
  */
  ...
  fake_onhashchange = (function(){
    ...
    // vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
    navigator.userAgent.indexOf("MSIE") > 0 && !supports_onhashchange && (function(){
...
/* ----------------------------------------------------------------------
   - public/javascripts/jquery.dotdotdot.js (last modified: 2015-11-10 00:53:02 +0000)
   ---------------------------------------------------------------------- */
/*	
...
/* ----------------------------------------------------------------------
   - public/javascripts/rails.js (last modified: 2015-11-10 00:53:02 +0000)
   ---------------------------------------------------------------------- */
(function($, undefined) {
 ...
 */
  ...
  if (rails.fire($(document), 'rails:attachBindings')) {
    // Scribd
    // We do our own CSRF Protection. - Mike Lewis Dec 19th 2013.
...
/* ----------------------------------------------------------------------
   - public/javascripts/mobile/mobile.js (last modified: 2016-01-21 00:14:18 +0000)
   ---------------------------------------------------------------------- */
Scribd = window.Scribd || {};
Scribd.Mobile = Scribd.Mobile || {};
...
/* ----------------------------------------------------------------------
   - public/javascripts/jquery.velocity.js (last modified: 2015-11-10 00:53:02 +0000)
   ---------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------
   - public/javascripts/velocity.ui.js (last modified: 2015-11-10 00:53:02 +0000)
   ---------------------------------------------------------------------- */
/**********************
   Velocity UI Pack
**********************/
...
/* ----------------------------------------------------------------------
   - public/javascripts/cookiejar.jquery.coffee (last modified: 2016-05-24 20:14:50 +0000)
   ---------------------------------------------------------------------- */
(function() {
  var CookieJar;

  CookieJar = (function() {
    CookieJar.prototype.append_string = "__CJ_";
    ...
    function CookieJar(options) {
      ...
      if (this.options.expires !== "") {
        now = +(new Date);
        d = new Date(now + this.options.expires * 1000);
        this.options.expires = "; expires=" + d.toGMTString();
      }
    ...
    CookieJar.prototype.put = function(name, value) {
      var cookie_str, e, error;
      name = this.append_string + name;
      switch (typeof value) {
        case "undefined":
        case "function":
        case "unknown":
      ...
      cookie_str = name + " = " + (escape(JSON.stringify(value)));
      try {
        document.cookie = cookie_str + this.options.expires + this.options.path + this.options.domain + this.options.secure;
        return true;
      } catch (error) {
        e = error;
        return false;
    ...
    CookieJar.prototype.remove = function(name) {
      var c, e, error, expires, now;
      now = +(new Date);
      expires = "; expires=" + (new Date(now - 3600 * 1000)).toGMTString();
      try {
        c = name + "=" + expires + this.options.path + this.options.domain + this.options.secure;
        document.cookie = c;
        return true;
      } catch (error) {
        e = error;
    ...
    CookieJar.prototype.get = function(name) {
      ...
      if (m = document.cookie.match(name + '=(.*?)(;|$)')) {
        return $.parseJSON(unescape(m[1]));
      }
    };

    CookieJar.prototype.get_keys = function() {
      var i, key, key_re, keys, len, ref;
      keys = [];
      key_re = new RegExp("^" + this.append_string);
      ref = document.cookie.match(/[^=; ]+(?=\=)/g);
    ...
    CookieJar.prototype.empty = function() {
...
/* ----------------------------------------------------------------------
   - public/javascripts/jquery_global/forms.coffee (last modified: 2016-07-08 22:43:33 +0000)
   ---------------------------------------------------------------------- */
(function() {
  $(function() {
    return $(document).on("submit", "form", (function(_this) {
      return function(e) {
        var buttons, elm, elms, form, i, len;
        form = $(e.currentTarget);
        buttons = form.find(".flat_btn");
        if (buttons.length) {
          elms = (function() {
            var i, len, results;
            results = [];
          ...
          return form.on("ajax:complete.submit_loading", function() {
            var j, len1;
            ...
            return form.off("ajax:complete.submit_loading");
          });
        }
      };
    })(this));
  ...
  $.fn.fancy_select = function() {
    var check_height, close_menu, el, menu, open_menu, options, picker, selected;
    if (!this.length) {
      return this;
    }
    el = this.first();
    ...
    picker = $("<button class='fancy_select has_ticks'> <span class='fancy_select_label'></span> <span class='sprite white_tri_up'></span> <span class='sprite white_tri_down'></span> </button>");
    picker.find(".fancy_select_label").html(selected.html());
    menu = $("<div class='fancy_select_menu'></div>");
    check_height = true;
    open_menu = function() {
      var offset;
      ...
      menu.appendTo(document.body).css({
        left: offset.left + "px",
        top: (offset.top + picker.height()) + "px"
      }).stop(true);
      if (check_height) {
        if (menu.height() > 300) {
          $("<div class='fancy_menu_inner'></div>").append(menu.children()).appendTo(menu);
        }
        check_height = false;
      }
      return menu.hide().slideDown("fast");
    };
    close_menu = function() {
      picker.removeClass("open");
      return menu.stop(true).slideUp("fast", (function(_this) {
        return function() {
          return menu.detach();
        };
      })(this));
    };
    options.addClass("fancy_option").appendTo(menu);
    picker.on("click", (function(_this) {
      return function(e) {
        if (picker.is(".open")) {
          close_menu();
        } else {
    ...
    menu.on("click", ".fancy_option", (function(_this) {
      return function(e) {
        close_menu();
        return el.trigger("scribd:fancy_select", [e.currentTarget]);
      };
    })(this));
    el.hide().after(picker);
...
/* ----------------------------------------------------------------------
   - public/javascripts/jquery_global/facebook.coffee (last modified: 2016-02-18 20:37:13 +0000)
   ---------------------------------------------------------------------- */
(function() {
  Scribd.facebook_login_status = jQuery.Deferred();

  window.fbAsyncInit = function() {
    return Scribd.with_named_current_user(function() {
      Scribd.facebook = new Scribd.Facebook;
      return Scribd.Facebook.loaded.resolve();
    });
  };

  Scribd.Facebook = (function() {
    Facebook.loaded = $.Deferred();

    Facebook.setup = function() {
      var s;
      s = document.createElement("script");
      s.type = "text/javascript";
      s.src = document.location.protocol + '//connect.facebook.net/en_US/sdk.js';
      s.async = true;
      return document.getElementById("fb-root").appendChild(s);
    };

    Facebook.prototype.app_id = '113489444764';

    Facebook.prototype.permissions = "email,publish_actions";

    Facebook.prototype.namespace = "scribdtestdev";

    Facebook.prototype.link_url = "/facebook_link";

    function Facebook() {
      this.cookie = new Scribd.JSONCookie("session_metadata");
      this.connect();
      $(document).trigger("facebook:initialized");
    }
    ...
    Facebook.prototype.login = function(callback) {
      ...
      wrapped = (function(_this) {
        return function(res) {
          if (res != null ? res.authResponse : void 0) {
            _this.session = res.authResponse;
            Scribd.with_named_current_user(function() {
              var user;
              user = Scribd.set_named_current_user(Scribd.named_current_user() || {});
              user.is_facebook_user = true;
              return user.facebook_user_id = _this.session.userID;
            });
            return callback != null ? callback.apply(null, arguments) : void 0;
          } else {
            _this.session = null;
      ...
      return FB.login(wrapped, {
        scope: this.permissions
      });
    };

    Facebook.prototype.login_and_link = function(callback) {
      return this.login((function(_this) {
        return function(res) {
          if (res) {
            return $.ajax(Scribd.facebook.link_url, {
              type: "post",
              success: function() {
                return typeof callback === "function" ? callback(true, res) : void 0;
              },
              error: function() {
                return typeof callback === "function" ? callback(false, res) : void 0;
              }
            });
          } else {
    ...
    Facebook.prototype.with_account = function(callback, force) {
      if (force == null) {
        force = false;
      }
      return Scribd.with_named_current_user(function() {
        if (!Scribd.named_current_user().is_facebook_user) {
          return;
        }
        return FB.getLoginStatus(function(arg) {
          var authResponse, auth_id, user_id;
          authResponse = arg.authResponse;
          auth_id = authResponse.userID.toString();
          user_id = Scribd.named_current_user().facebook_user_id.toString();
          if (auth_id !== user_id) {
            if (force) {
              return FB.logout((function(_this) {
                return function() {
                  return FB.login(function() {
                    return _this.with_account(callback, force);
                  });
                };
              })(this));
            }
    ...
    Facebook.prototype.with_permission = function(perm, callback) {
      return this.check_permission(perm).then(callback, (function(_this) {
        return function() {
          return _this.login(callback);
        };
      })(this));
    };

    Facebook.prototype.check_permission = function(perm) {
      var promise;
      promise = jQuery.Deferred();
      FB.api('/me?fields=permissions', 'get', (function(_this) {
        return function(res) {
          var ref;
          if (((ref = res.permissions) != null ? ref.data[0][perm] : void 0) === 1) {
    ...
    Facebook.prototype.connect = function() {
      ...
      if ((ref = Scribd.Ads) != null ? ref.enabled : void 0) {
        if ((ref1 = Scribd.Ads) != null) {
          ref1.setFacebookAttribute();
        }
      }
      return this.get_session((function(_this) {
        return function() {
          return _this.instant = new Scribd.Facebook.InstantPersonalize(_this);
        };
      })(this));
    };

    Facebook.prototype.get_session = function(callback) {
      var last;
      this.session = null;
      if (("" + (this.cookie.get("active_facebook_session"))) === "false" && (last = this.cookie.get("last_facebook_ping"))) {
        Scribd.facebook_login_status.reject();
        if (+(new Date) - last < 1000 * 60 * 60) {
          return;
        }
      }
      return FB.getLoginStatus((function(_this) {
        return function(res) {
          if (res.status === "connected") {
            ...
            return Scribd.facebook_login_status.resolve(res.status);
          } else {
            _this.cookie.set("active_facebook_session", "false");
            _this.cookie.set("last_facebook_ping", +(new Date));
            _this.cookie.save();
            return Scribd.facebook_login_status.reject(res.status);
          }
        };
      })(this));
    };
  ...
  Scribd.Facebook.InstantPersonalize = (function() {
    InstantPersonalize.context = "newhome";

    InstantPersonalize.prototype.try_remember_id = function() {
      if (this.facebook.session) {
        this.cookie.set("last_facebook_uid", this.facebook.session.userID);
        return this.cookie.save();
      }
    };

    function InstantPersonalize(facebook) {
      this.facebook = facebook != null ? facebook : Scribd.facebook;
      this.cookie = this.facebook.cookie;
      this.try_remember_id();
    }

    return InstantPersonalize;
...
/* ----------------------------------------------------------------------
   - public/javascripts/jquery_global/draggable.coffee (last modified: 2016-01-15 19:39:42 +0000)
   ---------------------------------------------------------------------- */
(function() {
  $.fn.draggable = function(opts) {
    ...
    drag_move = (function(_this) {
      return function(e, _x, _y) {
        ...
        mouse_x += dx;
        mouse_y += dy;
        return typeof opts.move === "function" ? opts.move(dx, dy, _x, _y) : void 0;
      };
    })(this);
...
/* ----------------------------------------------------------------------
   - public/javascripts/jquery_global/pingback.coffee (last modified: 2016-05-17 23:37:24 +0000)
   ---------------------------------------------------------------------- */
(function() {
  Scribd.send_pingback = function(split_pingback_url) {
    var data, ref, url;
    url = split_pingback_url.join("");
    if (typeof navigator !== "undefined" && navigator !== null ? (ref = navigator.userAgent) != null ? ref.match(/Google (Web|Instant) Preview/) : void 0 : void 0) {
      return;
    }
    data = {};
...
/************************************************************************
 * :files, 'app/views', ... (last modified: 2016-05-03 20:22:21 +0000)
 ************************************************************************/

/* ----------------------------------------------------------------------
   - app/views/chrome/flasher.coffee (last modified: 2016-04-12 18:04:44 +0000)
   ---------------------------------------------------------------------- */
(function() {
  Scribd.Flasher = (function() {
    Flasher.prototype.duration = 10000;

    Flasher.prototype.animation_duration = 250;

    Flasher.prototype.clipping = "-7px";

    function Flasher(container, opts) {
      var base, base1;
      this.container = container;
      this.opts = opts != null ? opts : {};
      if ((base = this.opts).dismiss == null) {
        base.dismiss = true;
      }
      if ((base1 = this.opts).raw == null) {
        base1.raw = false;
      }
    ...
    Flasher.prototype.dismiss = function($el) {
      if (!($el != null ? $el : $el = this.current_flash)) {
        return;
      }
      if (this.timeout) {
      ...
      if (this.container) {
        return $el.slideUp((function(_this) {
          return function() {
            return $el.remove();
          };
        })(this));
        ...
        $el.css({
          "margin-top": "-" + ($el.outerHeight() + 4) + "px"
        });
    ...
    Flasher.prototype.show = function(type, msg, raw) {
      var $el;
      if (raw == null) {
        raw = false;
      }
      ...
      if (this.container) {
        $el = $("<div class='flasher_notification " + type + "'>");
      } else {
        $el = $("<div class='global_flash " + type + "'>");
      }
      if (raw || this.opts.raw) {
        $el.html(msg);
      } else {
        $el.text(msg);
      }
...
/* ----------------------------------------------------------------------
   - app/views/chrome/marla.coffee (last modified: 2016-03-03 23:50:01 +0000)
   ---------------------------------------------------------------------- */
(function() {
  $(function() {
    Scribd.marla = function() {
      var $el, div, element, i, len, ref, results, span;
      ref = $("[data-marla]");
      results = [];
      for (i = 0, len = ref.length; i < len; i++) {
        element = ref[i];
        ...
        div.css({
          ...
          opacity: 0.5,
          "z-index": 10,
          "background-image": "url(" + ($el.data('marla')) + ")",
        ...
        $el.append(div);
        span = $("<span> Press M to toggle off</span>");
        span.css({
          "font-weight": "bold",
          "color": "black"
        });
        div.append(span);
        results.push(div.fadeToggle());
      }
      return results;
    };
    $(document).on("keyup", (function(_this) {
      return function(e) {
        var marla, marla_data;
        if (e.keyCode === 77) {
          marla = $(".marla");
          if (!marla.length) {
            return;
          }
          marla_data = marla.data("parent").attr("data-marla");
          marla.css({
            "backgroundImage": "url('" + marla_data + "')"
          });
          return marla.fadeToggle();
        }
      };
    })(this));
    return Scribd.marla();
...
/* ----------------------------------------------------------------------
   - app/views/shared/buy_doc_manager.coffee (last modified: 2016-05-03 20:22:21 +0000)
   ---------------------------------------------------------------------- */
(function() {
  Scribd.BuyDocManager = (function() {
    BuyDocManager.for_current_doc = function() {
      var buy_url, missing_page_label, missing_page_title, ref;
      if (this.buy_manager) {
        return this.buy_manager;
      }
      ref = Scribd.current_doc, buy_url = ref.buy_url, missing_page_label = ref.missing_page_label, missing_page_title = ref.missing_page_title;
      this.buy_manager = new Scribd.BuyDocManager(buy_url);
      this.buy_manager.setup_buy_buttons(missing_page_label);
      this.buy_manager.setup_missing_page_title(missing_page_title);
      return this.buy_manager;
    };

    function BuyDocManager(buy_url) {
      if (_.isArray(buy_url)) {
        buy_url = buy_url.join("");
      }
    ...
    BuyDocManager.prototype.setup_missing_page_title = function(title_text) {
      var $doc;
      if (Scribd.eligible_for_archive_blur_test && Scribd.nway_test_choice_value("archive_blur") === "variant") {
      ...
      return (function(_this) {
        return function() {
          ...
          if (Scribd.logged_in) {
            ...
            Scribd.Lightbox.remote_open("login_to_download_lb", "https://sbx.scribd.com/archive/login?" + params, Scribd.toolbar_params(Scribd.current_doc), Scribd.LoginToContinueLightbox);
          }
          return false;
        };
      })(this);
...
/* ----------------------------------------------------------------------
   - app/views/chrome/login/_facebook_login_button.coffee (last modified: 2016-07-08 22:43:32 +0000)
   ---------------------------------------------------------------------- */
(function() {
  Scribd.FacebookLoginButton = (function() {
    FacebookLoginButton.prototype.parse_cookie = function() {
      var _, cookie, match, name, ref, value;
      cookie = document.cookie;
      if (match = cookie.match(/(fbs_[a-f0-9]*)\s*=\s*([^;]+)/)) {
        _ = match[0], name = match[1], value = match[2];
        value = ((ref = value.match(/^"(.*)"$/)) != null ? ref[1] : void 0) || value;
        return {
          fbs_cookie: value,
          fbs_cookie_name: name
        };
      } else {
        return {
          fbs_cookie: "none"
    ...
    FacebookLoginButton.prototype.on_login = function(res) {
      var k, ref, ref1, v;
      this.button.removeClass("loading").prop("disabled", false);
      if (res != null ? res.authResponse : void 0) {
        ref = this.parse_cookie();
        for (k in ref) {
          v = ref[k];
          this.add_hidden(k, v);
        }
        ref1 = res.authResponse;
        for (k in ref1) {
          v = ref1[k];
          this.add_hidden("facebook_session[" + k + "]", v);
        }
        if (this.container.data("remote")) {
          return this.submit_remotely();
        } else {
    ...
    FacebookLoginButton.prototype.submit_remotely = function() {
      var data, url;
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function(res) {
            if (res.success) {
              if (res.email_missing) {
                return _this.container.trigger("Scribd:Facebook:email_missing", [res]);
              } else {
                return _this.container.trigger("Scribd:Facebook:login_success", [res]);
              }
            } else {
              return _this.container.find('.fb_fail_message').show();
            }
          };
        })(this),
    ...
    FacebookLoginButton.prototype.add_hidden = function(name, value) {
      this.fields || (this.fields = this.form.find(".session_fields"));
      return $('<input type="hidden" />').attr("name", name).attr("value", value).appendTo(this.fields);
    };

    function FacebookLoginButton(container) {
      this.container = $(container);
      this.container.data("created", true);
      this.form = this.container.find("form");
      this.button = this.container.find(".flat_btn");
      this.container.click((function(_this) {
        return function() {
          _this.container.trigger("scribd:facebook_login");
          _this.button.addClass("loading").prop("disabled", true);
          return Scribd.facebook.login(function(r) {
            return _this.on_login(r);
          });
        };
      })(this));
    }
...
/* ----------------------------------------------------------------------
   - app/views/mobile/accounts/annual_upsell.coffee (last modified: 2016-05-16 17:47:33 +0000)
   ---------------------------------------------------------------------- */
(function() {
  var Mobile;

  Mobile = Scribd.init('Scribd', 'Mobile');

  Mobile.AnnualUpsell = (function() {
    function AnnualUpsell(container, opts) {
      this.opts = opts;
      this.container = $(container);
      this.setup_events();
    }

    AnnualUpsell.prototype.setup_events = function() {
      this.container.on("ajax:success", (function(_this) {
        return function() {
          return window.location = "/mobile/annual_upsell_success";
        };
      })(this));
      return this.container.on("ajax:error", (function(_this) {
        return function(e, xhr, error) {
          return window.location = "/mobile/annual_upsell_failure";
        };
      })(this));
    };
...
/* ----------------------------------------------------------------------
   - app/views/mobile/accounts/login.coffee (last modified: 2016-02-05 22:21:55 +0000)
   ---------------------------------------------------------------------- */
(function() {
  var Mobile;
  ...
  Mobile.Login = (function() {
    function Login(container, opts) {
      this.opts = opts;
      this.container = $(container);
      this.errors = this.container.find(".errors").first();
      this.category = this.container.data("track_category");
      this.setup_events();
    }

    Login.prototype.setup_events = function() {
      this.track("view", "page");
      this.container.dispatch("click", {
        scribd_fb_button: (function(_this) {
          return function() {
            _this.track("click", "facebook_button");
            return "continue";
          };
        })(this),
        sign_in_btn: (function(_this) {
          return function() {
            _this.track("click", "sign_in");
            return "continue";
          };
        })(this),
        forgot_password_link: (function(_this) {
          return function() {
            _this.track("click", "forgot_password");
            return "continue";
          };
        })(this),
        join_today_link: (function(_this) {
          return function() {
            _this.track("click", "join_today");
            return "continue";
          };
        })(this),
        join_now_btn: (function(_this) {
          return function() {
            _this.track("click", "join_button");
            return "continue";
          };
        })(this)
      });
      this.container.on("change", "#send_updates_checkbox", (function(_this) {
        return function() {
          return _this.track("click", "send_updates", {
            checked: _this.container.find("#send_updates_checkbox").prop("checked")
          });
        };
      })(this));
      this.container.on("submit", (function(_this) {
        return function() {
          return _this.errors.hide();
        };
      })(this));
      return this.container.on("ajax:success Scribd:Facebook:login_success", (function(_this) {
        return function(e, res) {
          var error_message, next_url, ref, ref1, ref2;
          error_message = (ref = res.failure_message) != null ? ref : (ref1 = res.errors) != null ? (ref2 = ref1[0]) != null ? ref2.msg : void 0 : void 0;
          if (error_message) {
            _this.track("view", "error");
            return _this.errors.text(error_message).show();
          } else if (res.redirect_to) {
            return window.location = res.redirect_to;
          } else if (res.success) {
            next_url = _this.container.find("[name='login_params[next_url]']").val();
            return window.location = next_url != null ? next_url : "..";
          }
        };
      })(this));
    };

    Login.prototype.track = function(verb, noun, params) {
      var label, ref;
      if (params == null) {
        params = {};
      }
      label = this.category + ":" + noun + ":" + verb;
      params.platform = (ref = this.opts.platform) != null ? ref : "unknown";
      return this.container.track_rats(label, params);
    };
...
/* ----------------------------------------------------------------------
   - app/views/mobile/ad_code.js (last modified: 2015-11-10 00:53:08 +0000)
   ---------------------------------------------------------------------- */
(function(ads){
    // exports
    /******* Scirbd.Mobile.Ads.sticky *******/
    ads.sticky = function(ad, offsetBeforePinning) {
        ad = $(ad);
        if ( ad.length > 0 ) {
            var pinHandler = function(e) { pin(ad, offsetBeforePinning); };
            TouchGestures.enabled && document.addEventListener(TouchGestures.touchEvent('touchmove'), pinHandler, false);
            $(document).scroll(pinHandler);
        }
    };
    ...
    // internals
    function pin(ad, offsetBeforePinning) {
        var ad = $(ad);
        if ( ad.length > 0 ) {
            var winYOffset = window.pageYOffset !== void(0) ? window.pageYOffset : document.body.scrollTop;
            if ( winYOffset > offsetBeforePinning ) {
                !ad.hasClass('pinned') && ad.addClass('pinned');
            } else {
                ad.hasClass('pinned') && ad.removeClass('pinned');
            }
        }
    }
}(Scribd.init('Scribd', 'Mobile', 'Ads')));


/* ----------------------------------------------------------------------
   - app/views/mobile/apps/kindlefire.coffee (last modified: 2016-02-05 22:21:55 +0000)
   ---------------------------------------------------------------------- */
(function() {
  var Apps;

  Apps = Scribd.init('Scribd', 'Mobile', 'Apps');

  Apps.KindleFire = (function() {
    function KindleFire(container, opts) {
      this.opts = opts;
      this.container = $(container);
      this.instructions = this.container.find("#install-instructions-container");
      this.container.dispatch("click", {
        show_instructions: (function(_this) {
          return function(btn, e) {
            e.preventDefault();
            return _this.instructions.show().height($(document).height());
          };
        })(this),
        hide_instructions: (function(_this) {
          return function(btn, e) {
            e.preventDefault();
            return _this.instructions.hide();
          };
        })(this)
      });
    }
...
/* ----------------------------------------------------------------------
   - app/views/mobile/documents/book.coffee (last modified: 2016-02-05 22:21:55 +0000)
   ---------------------------------------------------------------------- */
(function() {
  var Mobile;
  ...
  Mobile.BookView = (function() {
    function BookView(container, opts) {
      this.opts = opts;
      this.container = $(container);
      this.$header = this.container.find('.book-header');
      this.$subscribePromo = this.container.find('.subscribe-promo');
      this.container.dispatch('click', {
        more: (function(_this) {
          return function(btn, e) {
            return _this.revealMore(e);
          };
        })(this),
        back: (function(_this) {
          return function(btn, e) {
        ...
        return_to_top: (function(_this) {
          return function(btn, e) {
            return _this.returnToTop(e);
          };
        })(this)
      });
      this.container.bind('show', _.once((function(_this) {
        return function() {
          _this.clampLines();
          return _this.clampContributors();
        };
      })(this)));
      if (this.container.is(':visible')) {
        this.container.trigger('show');
      }
      if (this.$subscribePromo.length > 0) {
        $(window).scroll(this.positionPromo.bind(this));
      }
    }

    BookView.prototype.goBack = function(e) {
      e.preventDefault();
      e.stopPropagation();
      if (!document.referrer || /scribd/.test(document.referrer)) {
        return history.back();
      } else {
    ...
    BookView.prototype.returnToTop = function(e) {
      return $('html, body').animate({
        scrollTop: 0
      });
    };

    BookView.prototype.revealMore = function(e) {
      var $clamped;
      $clamped = $(e.target).prev('.clamped');
      $clamped.trigger('destroy');
      $clamped.css('max-height', 'none');
      $clamped.removeClass('clamped');
      return $(e.target).remove();
    };

    BookView.prototype.positionPromo = _.throttle(function(e) {
      var fixed, scrollTop;
      if (this.promoOffset == null) {
        this.promoOffset = this.$subscribePromo.offset().top;
      }
      scrollTop = $(window).scrollTop();
      fixed = this.$subscribePromo.is('.fixed');
      if (!fixed && scrollTop >= this.promoOffset) {
        this.$subscribePromo.addClass('fixed');
        return this.container.css('margin-top', this.$header.outerHeight() + this.$subscribePromo.outerHeight() + "px");
      } else if (fixed && scrollTop < this.promoOffset) {
        this.$subscribePromo.removeClass('fixed');
        return this.container.css('margin-top', '0');
      }
    });

    BookView.prototype.clampLines = function() {
      return $('.clamped.dotdotdot').each(function(i, el) {
        var $el;
        $el = $(el);
        $el.dotdotdot();
        if (!$el.triggerHandler('isTruncated')) {
          return $el.next('.more').remove();
        }
      });
    };

    BookView.prototype.clampContributors = function() {
      return $('.clamped').each((function(_this) {
        return function(i, el) {
          var $contributors, $el, heights, maxHeight;
          $el = $(el);
          $contributors = $el.find('.contributors');
          if ($contributors.length === 0) {
            return;
          }
          heights = $contributors.find('li').map(function() {
            return $(this).height();
          });
          if (heights.length <= 3) {
            return _this.revealMore({
              target: $el.next('.more')[0]
            });
          }
          maxHeight = Math.max.apply(null, heights.slice(0, 3)) + 10;
          return $el.css('max-height', maxHeight + 'px');
        };
      })(this));
    };
...
/* ----------------------------------------------------------------------
   - app/views/mobile/shared/menu_container.coffee (last modified: 2016-01-15 19:39:42 +0000)
   ---------------------------------------------------------------------- */
(function() {
  var Mobile;
  ...
  Mobile.MenuContainer = (function() {
    function MenuContainer(container) {
      this.container = container;
      this.container = $(this.container);
      this.page_wrap = this.container.find(".page_wrap");
      this.setup_events();
      this.setup_selected();
    }

    MenuContainer.prototype.setup_events = function() {
      var zoom;
      this.container.dispatch("click", {
        toggle_nav: (function(_this) {
          return function() {
            if (!_this.container.hasClass("nav_visible")) {
              _this.container.addClass("nav_visible");
              return _this.page_wrap.one("click.menu_container", function(e) {
                e.stopPropagation();
                return _this.container.removeClass("nav_visible");
              });
            }
          };
        })(this)
      ...
      zoom = 1;
      return $(window).on("touchstart touchmove", _.throttle((function(_this) {
        return function() {
          var newZoom;
          newZoom = document.documentElement.clientWidth / window.innerWidth;
          if (newZoom !== zoom) {
            zoom = newZoom;
            return _this.container.toggleClass("header_hidden", zoom !== 1);
          }
        };
      })(this)));
    };

    MenuContainer.prototype.setup_selected = function() {
      var ref;
      return (ref = this.container.find(".main_nav > a[href^='" + location.pathname + "']").first()) != null ? ref.addClass("selected") : void 0;
    };
...
/* ----------------------------------------------------------------------
   - app/views/mobile/documents/index.coffee (last modified: 2016-01-15 19:39:42 +0000)
   ---------------------------------------------------------------------- */
(function() {
  var Mobile;
  ...
  Mobile.IndexView = (function() {
    IndexView.prototype.threshold = 15;

    function IndexView(container, opts) {
      this.container = container;
      this.opts = opts;
      this.container = $(this.container);
      this.docs = this.container.find("#docs");
    ...
    IndexView.prototype.setup_events = function() {
      return $(window).scroll(_.debounce((function(_this) {
        return function() {
          if ($(document).height() - _this.scroll_bottom() <= _this.threshold) {
            return _this.load_next_page();
          }
        };
      })(this)));
    };

    IndexView.prototype.load_next_page = function() {
      var next_page, params;
      if (this.loading || this.done) {
        return;
      }
      this.loading = true;
      next_page = this.docs.find(".doc-carousel-page").last().data("page") + 1;
      params = {
        page: next_page
      };
      this.loader.show();
      return $.get(this.opts.url, params, (function(_this) {
        return function(page) {
          ...
          if ($(page).children().length === 0) {
            ...
            return _this.docs.append(page);
          }
        };
      })(this));
    };

    IndexView.prototype.scroll_bottom = function() {
...
/* ----------------------------------------------------------------------
   - app/views/mobile/documents/show.coffee (last modified: 2016-05-24 18:39:54 +0000)
   ---------------------------------------------------------------------- */
(function() {
  var Mobile;
  ...
  Mobile.ReadPage = (function() {
    ReadPage.prototype.padding = 18;

    ReadPage.prototype.rat = function(key, data) {
      ...
      ref = (function() {
        switch (key) {
          case "show":
            return ["doc:view", data];
          case "doc_scroll":
            return ["doc:scroll", data];
          case "promo_scroll":
            return ["promo:scroll", data];
          case "promo_show":
            return ["mobile_promo:view", data];
          case "promo_download_app":
            return ["mobile_promo_cta:click", data];
          case "promo_continue":
            return ["mobile_promo_continue:click", data];
          case "header_download_show":
            return ["header-download:view", data];
          case "header_download_click":
            return ["header-download:click", data];
          case "store_promo_show":
            return ["sticky_footer:view", data];
          case "store_promo_close":
            return ["store-banner-close:click", data];
          case "store_promo_view":
            return ["store-banner-view:click", data];
          case "menu_toggle":
            return ["menu-toggle:click", data];
          case "fullscreen_enter":
            return ["fullscreen:enter", data];
          case "fullscreen_exit":
            return ["fullscreen:exit", data];
          case "keep_reading_show":
            return ["keep_reading_sign_up:view", data];
          case "keep_reading_show_alt":
            return ["keep_reading_sign_up:view", data];
          case "keep_reading_click":
            return ["keep_reading_sign_up:click", data];
          case "view_in_store_click":
            return ["sticky_footer:click", data];
          case "footer_view_in_app_click":
            return ["footer-view-in-app:click", data];
          case "footer_view_in_app_show":
            return ["footer-view-in-app:view", data];
          case "successful_signup_view":
            return ["successful_signup:view", data];
          case "carousel_doc_click":
            return ["carousel-doc:click", data];
          case "keep_reading_download":
            return ["keep_reading_sign_up:click", data];
          default:
            return [null, data];
        }
      ...
      rat_key = "mw_doc:" + append;
      rat_data.variation = this.opts.variation;
      rat_data.time = this.time_delta();
      rat_data.platform = this.opts.platform || "unknown";
      if (this.opts.alternate_phones) {
        rat_data.flow = "mw_alt";
      }
    ...
    function ReadPage(container, opts) {
      this.opts = opts;
      if (this.opts.roadblock_visible) {
        docManager.disableRestorePosition();
      }
      this.container = $(container);
      this.fetch_data();
      this.setup_test_assignment();
      this.setup_viewport();
      this.setup_width();
      this.setup_events();
      this.setup_buy();
    ...
    ReadPage.prototype.time_delta = function() {
      return Date.now() - this.start_time;
    };

    ReadPage.prototype.update_page_width = function() {
      return docManager._currentViewManager._setWidth($(window).width() - this.padding);
    };

    ReadPage.prototype.setup_width = function() {
      var debounced;
      ...
      return this.update_page_width();
    };

    ReadPage.prototype.setup_buy = function() {
      return Scribd.BuyDocManager.for_current_doc();
    };

    ReadPage.prototype.setup_test_assignment = function() {
      var placeholder, variation;
      this.variation = "control";
      this.container.addClass(this.variation);
      variation = this.variation;
      placeholder = "VARIATION_PLACEHOLDER";
      return $("[data-store_url*='" + placeholder + "']").each(function() {
        var $el, store_url;
        $el = $(this);
        store_url = $el.data("store_url").replace(placeholder, variation);
        return $el.data("store_url", store_url);
      });
    };

    ReadPage.prototype.setup_viewport = function() {
      this.initial_viewport = $("meta[name=viewport]").attr("content");
      return this.zoom_viewport = "width=device-width";
    };

    ReadPage.prototype.apply_viewport = function(viewport) {
      $("meta[name=viewport]").remove();
      return $("head").append("<meta name='viewport' content='" + viewport + "'>");
    };

    ReadPage.prototype.setup_events = function() {
      var doc_container;
      this.start_time = Date.now();
      doc_container = this.container.find(".doc_container");
      $(document).on("scroll", _.throttle((function(_this) {
        return function() {
          var doc_end, finished_doc, inside_doc, pos, scroll;
          scroll = $(window).scrollTop() + $(window).height();
          doc_end = doc_container.offset().top + doc_container.height();
          if (doc_end === 0) {
            return;
          }
          inside_doc = scroll <= doc_end;
          finished_doc = scroll > doc_end + (0.5 * $(window).height());
          finished_doc || (finished_doc = scroll >= $(document).height());
          _this.container.toggleClass("fullscreen_hidden", !inside_doc);
          if (!inside_doc) {
            _this.promo_visible();
          }
          if (!_this.view_in_app_has_been_seen) {
            pos = _this.container.find(".bottom_view_in_app_btn").position().top + _this.container.find(".view_in_store_promo").height();
            if (pos < $(document.body).scrollTop() + $(window).height()) {
              _this.view_in_app_has_been_seen = true;
              return _this.rat("footer_view_in_app_show");
            }
          }
        };
      })(this), 50));
      $(window).on("resize", (function(_this) {
        return function(e) {
          ...
          if (!_this.prev_orientation || _this.prev_orientation !== orientation) {
            if (_this.container.find(".main_header .app_btn").is(":visible")) {
              _this.rat("header_download_show");
            }
          }
          return _this.prev_orientation = orientation;
        };
      })(this));
      return this.container.dispatch("click", {
        thumbnail: (function(_this) {
          return function() {
            _this.rat("carousel_doc_click");
            return "continue";
          };
        })(this),
        close: (function(_this) {
          return function() {
            _this.rat("store_promo_close");
            _this.container.find(".fullscreen_btn").css("bottom", "16px");
            _this.container.find(".bottom_view_in_app_btn").css("margin-bottom", "10px");
            return false;
          };
        })(this),
        welcome_close_btn: (function(_this) {
          return function() {
            return _this.container.find(".welcome_message").slideUp();
          };
        })(this),
        view_in_store_link: (function(_this) {
          return function() {
            _this.rat("store_promo_view");
            return "continue";
          };
        })(this),
        toggle_nav: (function(_this) {
          return function() {
            _this.rat("menu_toggle");
            return "continue";
          };
        })(this),
        bottom_download_app_btn: (function(_this) {
          return function() {
            _this.rat("keep_reading_download");
            return "continue";
          };
        })(this),
        bottom_view_in_app_btn: (function(_this) {
          return function() {
            _this.rat("footer_view_in_app_click");
            return "continue";
          };
        })(this),
        bottom_signup_btn: (function(_this) {
          return function() {
            _this.rat("keep_reading_click");
            return "continue";
          };
        })(this),
        signup_banner_btn: (function(_this) {
          return function() {
            _this.rat("view_in_store_click");
            return "continue";
          };
        })(this),
        download_app_btn: (function(_this) {
          return function() {
            _this.rat("header_download_click");
            return "continue";
          };
        })(this),
        fullscreen_btn: (function(_this) {
          return function() {
            if (_this.container.is(".fullscreen")) {
    ...
    ReadPage.prototype.promo_visible = _.once(function() {
      if (this.opts.alternate_phones) {
        return this.rat("keep_reading_show_alt");
      } else {
        return this.rat("keep_reading_show");
      }
    });

    ReadPage.prototype.enter_fullscreen = function() {
      var offset, offset_scroll, scroll;
      if (this.container.is(".fullscreen")) {
        return;
      }
      this.rat("fullscreen_enter");
      this.container.addClass("fullscreen");
      this.padding = 0;
      this.update_page_width();
      this.apply_viewport(this.zoom_viewport);
      scroll = $(window).scrollTop();
      offset = this.container.find(".doc_container").offset().top;
      offset_scroll = scroll - offset;
      return $(window).scrollTop(offset_scroll);
    };

    ReadPage.prototype.exit_fullscreen = function() {
      var offset, offset_scroll, scroll;
      if (!this.container.is(".fullscreen")) {
        return;
      }
      this.rat("fullscreen_exit");
      this.container.removeClass("fullscreen");
      this.padding = 18;
      this.update_page_width();
      this.apply_viewport(this.initial_viewport);
      scroll = $(window).scrollTop();
      offset = this.container.find(".doc_container").offset().top;
      offset_scroll = scroll + offset;
      return $(window).scrollTop(offset_scroll);
    ...
    ReadPage.prototype.send_roadblock_tracking = function() {
      var _onscroll;
      this.rat("promo_show");
      if (!this.scroll_attached) {
        _onscroll = (function(_this) {
          return function(e) {
            if (!_this.container.hasClass("has_roadblock") && (new Date).getTime() > _this.allow_scroll_event_after) {
              _this.rat("doc_scroll");
              return $(document).off("scroll", _onscroll);
            }
          };
        })(this);
        $(document).on("scroll", _onscroll);
        this.scroll_attached = true;
      }
      $(document.body).one("scribd:promo:cta_btn:click", (function(_this) {
        return function() {
          return _this.rat("promo_download_app");
        };
      })(this));
      return $(document.body).one("scribd:roadblock:hide", (function(_this) {
        return function(e, hide_action) {
          var $store_promo;
          _this.allow_scroll_event_after = (new Date).getTime() + 500;
          if (hide_action === "scroll") {
            _this.rat("promo_scroll");
          } else if (hide_action === "continue") {
            _this.rat("promo_continue");
          }
          _this.opts.roadblock_visible = false;
          _this.send_tracking();
          _this.container.removeClass("has_roadblock");
          setTimeout(function() {
            return docManager.viewManagers.scroll.gotoPage(docManager.viewManagers.scroll.pagePosition()[0], {
              offset: _this.container.outerHeight()
            });
          }, 50);
          $store_promo = $(".view_in_store_promo");
          $store_promo.css("bottom", -$store_promo.outerHeight());
          return setTimeout(function() {
            return $(".view_in_store_promo").animate({
              bottom: 0
            });
          }, 100);
        };
    ...
    ReadPage.prototype.send_tracking = function() {
      if (this.opts.roadblock_visible) {
        return this.send_roadblock_tracking();
      }
      this.rat("show");
      if (this.container.find(".welcome_banner:visible").length > 0) {
        this.rat("successful_signup_view");
      }
    ...
    ReadPage.prototype.fetch_data = function() {
      var body;
      body = $(document.body);
...
/* ----------------------------------------------------------------------
   - app/views/mobile/shared/_app_button.coffee (last modified: 2016-01-21 00:14:18 +0000)
   ---------------------------------------------------------------------- */
(function() {
  var Mobile;
  ...
  Mobile.AppButton = (function() {
    function AppButton(container, opts) {
      this.container = container;
      this.opts = opts;
      $((function(_this) {
        return function() {
          _this.container = $(_this.container);
          return _this.container.dispatch("click", {
            app_btn: function() {
              _this.open_app();
              return "continue";
            }
    ...
    AppButton.prototype.open_app = function() {
      var app_url, delay, delta, iframe, open_store, store_url, timeout, ua;
      app_url = this.container.data("app_url");
      store_url = this.container.data("store_url");
      delay = 1000;
      delta = 500;
      ua = navigator.userAgent;
      if (ua.match(/Safari/) && ua.match(/Version\/9/)) {
        window.location.href = store_url;
        return;
      }
      open_store = function(time) {
        return function() {
          var wait;
          wait = delay + delta;
          if (Date.now() - time < wait) {
            return setTimeout(function() {
              return window.location.href = store_url;
            }, 50);
          }
        };
      };
      timeout = setTimeout(open_store(Date.now()), delay);
...
/* ----------------------------------------------------------------------
   - app/views/mobile/shared/_app_promo.coffee (last modified: 2016-04-12 18:04:44 +0000)
   ---------------------------------------------------------------------- */
(function() {
  var Mobile;
  ...
  Mobile.AppPromo = (function() {
    function AppPromo(container, opts) {
      var ref;
      this.container = container;
      this.opts = opts;
      this.container = $(this.container);
      this.background = $((ref = this.opts.background) != null ? ref : '.global_wrapper');
    ...
    AppPromo.prototype.setup_events = function() {
      var _onscroll;
      if (this.opts.same_page_roadblock) {
        _onscroll = (function(_this) {
          return function(e) {
            if (window.scrollY >= _this.container.outerHeight() - 20) {
              _this.hide('scroll');
      ...
      return this.container.dispatch('click', {
        cta_btn: (function(_this) {
          return function(btn, e) {
            _this.container.trigger("scribd:promo:cta_btn:click");
            return "continue";
          };
        })(this),
        continue_btn: (function(_this) {
          return function(btn, e) {
            _this.cookie.put('ap-dismissed', '1');
            $(window).off("scroll", _onscroll);
            if (_this.opts.same_page_roadblock) {
              return $(document.body).animate({
                scrollTop: _this.container.outerHeight()
              }, 500, function() {
                return _this.hide('continue');
              });
            } else {
              if (btn.attr('href') === '#') {
                e.preventDefault();
    ...
    AppPromo.prototype.render = function() {
      if (this.roadblock()) {
        return this.show();
      } else {
        return this.hide();
    ...
    AppPromo.prototype.roadblock = function() {
      var recently_dismissed, url_override;
      url_override = location.search.match(/skip_app_promo/);
      if (url_override) {
        return false;
      }
      if (this.opts.force_display) {
        return true;
      }
      recently_dismissed = this.cookie.get('ap-dismissed') === '1';
      return !recently_dismissed;
    };

    AppPromo.prototype.show = function() {
      this.container.trigger("scribd:roadblock:show").show();
      return this.background.hide();
    };

    AppPromo.prototype.hide = function(action) {
      if (action == null) {
        action = "";
      }
      this.background.show();
      this.background.trigger('show');
      return this.container.trigger("scribd:roadblock:hide", action).hide();
    };

    AppPromo.prototype.context = function() {
      if (this.container.hasClass('roadblock')) {
        return 'app-promo2:roadblock';
      } else {
        return 'app-promo2';
      }
    };
...
/* ----------------------------------------------------------------------
   - app/views/mobile/shared/_banner_promo.coffee (last modified: 2015-11-10 00:53:08 +0000)
   ---------------------------------------------------------------------- */
(function() {
  Scribd.BannerPromo = (function() {
    function BannerPromo(container, opts) {
      var base;
      this.opts = opts != null ? opts : {};
      this.$el = $(container);
      if ((base = this.opts).platform == null) {
        base.platform = '';
      }
      this.setup_events();
    }

    BannerPromo.prototype.setup_events = function() {
      this.$el.find('.close-button').click((function(_this) {
        return function(e) {
          return _this.$el.slideUp();
        };
      })(this));
      return this.$el.find('.install-button').click((function(_this) {
        return function(e) {
          return trackEvent(_this.opts.platform + ":mobile", 'click', 'install-button');
        };
      })(this));
    };
...
/* ----------------------------------------------------------------------
   - app/views/mobile/shared/_view_in_store_promo.coffee (last modified: 2016-01-21 00:14:18 +0000)
   ---------------------------------------------------------------------- */
(function() {
  Scribd.ViewInStorePromo = (function() {
    function ViewInStorePromo(container, opts) {
      this.opts = opts != null ? opts : {};
      this.container = $(container);
      this.default_opts();
      this.setup_events();
    ...
    ViewInStorePromo.prototype.default_opts = function() {
      return this.opts = _.extend({
        platform: ''
      }, this.opts);
    };

    ViewInStorePromo.prototype.setup_events = function() {
      this.container.dispatch("click", {
        view_in_store_link: (function(_this) {
          return function() {
            trackEvent(_this.opts.platform + ":mobile", 'click', 'view_in_store_link');
            return "continue";
          };
        })(this),
        close: (function(_this) {
      ...
      return this.container.click((function(_this) {
        return function(e) {
          ...
          if ($(e.target).is(".view_in_store_link")) {
            return;
          }
          return _this.container.find(".view_in_store_link").click();
        };
      })(this));
    };

    return ViewInStorePromo;
...
/* ----------------------------------------------------------------------
   - app/views/payments/mobile_checkout_flow/billing.coffee (last modified: 2015-11-10 00:53:08 +0000)
   ---------------------------------------------------------------------- */
(function() {
  var Payments;

  Payments = Scribd.init('Scribd', 'Mobile', 'Payments');

  Payments.Billing = (function() {
    function Billing(container) {
      this.container = $(container);
      this.tabs = this.container.find(".tab");
      this.pages = this.container.find(".page");
      this.paypal_page = this.container.find(".paypal.page");
      this.cc_page = this.container.find(".cc.page");
      this.container.dispatch("click", {
        tab: (function(_this) {
          return function($el, e) {
            ...
            $el.addClass("active");
            if ($el.is(".paypal")) {
              return _this.paypal_page.show();
            } else {
              return _this.cc_page.show();
            }
          };
        })(this),
        cancel: function() {
...
/* ----------------------------------------------------------------------
   - app/views/payments/mobile_checkout_flow/_credit_card.coffee (last modified: 2016-02-05 22:21:55 +0000)
   ---------------------------------------------------------------------- */
(function() {
  var Payments;
  ...
  Payments.CreditCardView = (function() {
    function CreditCardView(container, opts) {
      this.opts = opts;
      this.container = $(container);
      this.cc_number = this.container.find("input.cc-number").payment("formatCardNumber");
      this.cc_month = this.container.find("select.cc-exp-month");
      this.cc_year = this.container.find("select.cc-exp-year");
      this.cc_cvc = this.container.find("input.cc-cvc").payment("formatCardCVC");
      this.cc_country = this.container.find(".country_select select");
      this.state_container = this.container.find(".state-container");
      this.state_label = this.container.find(".state_label");
      this.state_input = this.state_container.find('input');
      this.zip_code_label = this.container.find(".zip_label");
      this.form = this.container.find("form");
      this.overlay = $(".overlay");
      this.init_events();
    }

    CreditCardView.prototype.init_events = function() {
      var prev_type;
      ...
      this.container.find("input").change(function(e) {
        return $(e.target).removeClass("error");
      });
      this.container.find("select").change((function(_this) {
        return function(e) {
          _this.cc_month.parent().removeClass("error");
          return _this.cc_year.parent().removeClass("error");
        };
      })(this));
      this.cc_country.change((function(_this) {
        return function(e) {
          if (_this.cc_country.val() === "United States") {
            _this.state_container.show();
            _this.state_label.html(_this.opts.state);
            return _this.zip_code_label.html(_this.opts.zip_code);
          } else if (_this.cc_country.val() === "Canada") {
            _this.state_container.show();
            _this.state_label.html(_this.opts.province);
            return _this.zip_code_label.html(_this.opts.postal_code);
          } else {
            _this.state_input.val("");
            _this.state_container.hide();
            return _this.zip_code_label.html(_this.opts.postal_code);
          }
        };
      })(this));
      prev_type = null;
      this.cc_number.on('payment.cardType', (function(_this) {
        return function(e, type) {
          var parent;
          parent = _this.cc_number.parent();
          parent.removeClass(prev_type);
          parent.addClass(type);
          return prev_type = type;
        };
      })(this));
      this.cc_number.blur((function(_this) {
        return function() {
          if ($.payment.validateCardNumber(_this.cc_number.val())) {
            return _this.cc_number.parent().addClass("identified");
          } else {
            return _this.cc_number.parent().removeClass("identified");
          }
        };
      })(this));
      return this.cc_cvc.blur((function(_this) {
        return function() {
          if ($.payment.validateCardCVC(_this.cc_cvc.val())) {
            return _this.cc_cvc.parent().addClass("identified");
          } else {
            return _this.cc_cvc.parent().removeClass("identified");
          }
        };
      })(this));
    };

    CreditCardView.prototype.validate = function() {
      var valid;
      valid = true;
      if (!$.payment.validateCardNumber(this.cc_number.val())) {
        this.cc_number.addClass("error");
        valid = false;
      }
      if (!$.payment.validateCardExpiry(this.cc_month.val(), this.cc_year.val())) {
        this.cc_month.parent().addClass("error");
        this.cc_year.parent().addClass("error");
        valid = false;
      }
      if (!$.payment.validateCardCVC(this.cc_cvc.val())) {
        this.cc_cvc.addClass("error");
        valid = false;
      }
      return valid;
    };

    CreditCardView.prototype.submit = function(e) {
      if (this.validate()) {
