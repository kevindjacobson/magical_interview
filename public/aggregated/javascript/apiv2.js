...
/* ----------------------------------------------------------------------
   - app/views/apiv2/docs/index.coffee (last modified: 2015-11-10 00:53:08 +0000)
   ---------------------------------------------------------------------- */
(function() {
  Scribd.UI.SetupApiv2Doc = function(container) {
    var $container;
    $container = $(container);
    return $container.find(".title").click((function(_this) {
      return function(e) {
        return $(e.target).closest(".endpoint").find(".content").slideToggle("medium");
      };
    })(this));
  };
